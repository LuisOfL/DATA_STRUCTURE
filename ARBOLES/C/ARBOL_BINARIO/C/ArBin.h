...
int CantHojas(ArBin a){
     if(esvacioAB(a)){return 0;}
     else if(esvacioAB(derAB(a)) && esvacioAB(izqAB(a))){return 1;}
     else
        return CantHojas(izqAB(a))+CantHojas(derAB(a));
}

int TotAB(ArBin a){
    if(esvacioAB(a)){return 0;}
    else
        return raiz(a) + TotAB(derAB(a)) + TotAB(izqAB(a));
